...
pub fn addTools(
    ...
    // Host capability profiles -- see binutils_gas.zig for rationale. These
    // tools (ar, objdump, etc.) are installed binaries compiled for host_target.
    ...
    // binutils/config.in keys (binutils 2.44)
    const binutils_config_header = b.addConfigHeader(.{
        ...
        .HAVE_STRUCT_STAT_ST_ATIMESPEC_TV_NSEC = if (t.os.tag == .macos) true else null,
        .HAVE_STRUCT_STAT_ST_ATIM_ST__TIM_TV_NSEC = null,
        .HAVE_STRUCT_STAT_ST_ATIM_TV_NSEC = gnu,
        ...
        .TYPEOF_STRUCT_STAT_ST_ATIM_IS_STRUCT_TIMESPEC = gnu,
